...
parser.add_argument("--model_arch", type=str, default="mistral_7b") # 预训练模型架构,可选phi2或mistral_7b
parser.add_argument("--train_maxlen", type=int, default=1024) # 训练时最大序列长度
parser.add_argument("--test_maxlen", type=int, default=1024) # 测试时最大序列长度  
